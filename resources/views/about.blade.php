                ...
                <div class="inner-content">
                    <div class="hp-text-block">
                        ...
                        <div class="owl-carousel text-rotation">
                            <div class="item">
                                <div class="sp-subtitle">Start Up IT</div>
                            </div>
                            <div class="item">
                                <div class="sp-subtitle">PT. Balla Cerdas Teknologi</div>
                            </div>
                        </div>
                        <!-- /Text rotation / Subtitle -->
                ...
                <div class="col-inner">
                    <div class="info-list-w-icon">
                        ...
                        <div class="info-block-w-icon">
                            ...
                            <div class="ci-text">
                                <h4>Research</h4>
                                <p>Melakukan Riset untuk Pengembangan Teknologi Informasi dan Komunikasi.</p>
                            </div>
                        </div>
                        <!-- /Service Item 1 -->
                        ...
                        <div class="info-block-w-icon">
                            ...
                            <div class="ci-text">
                                <h4>Development</h4>
                                <p>Menciptakan, Membangun dan Mengembangkan Produk dalam bentuk Barang 
                                    dan Jasa di bidang Teknologi Informasi dan Komunikasi.</p>
                            </div>
                        </div>
                        <!-- Service Item 2 -->
                    </div>
                ...
                <div class="col-inner">
                    <div class="info-list-w-icon">
                        ...
                        <div class="info-block-w-icon">
                            ...
                            <div class="ci-text">
                                <h4>Ecommerce</h4>
                                <p>Melakukan Penjualan Produk Teknologi Informasi dan Komunikasi dalam 
                                    bentuk Barang dan Jasa.</p>
                            </div>
                        </div>
                        <!-- Service Item 3 -->
                        ...
                        <div class="info-block-w-icon">
                            ...
                            <div class="ci-text">
                                <h4>Social</h4>
                                <p>Melakukan kegiatan-kegiatan sosial yang positif dalam pandangan Agama dan 
                                    Hukum yang berlaku di Negara Kesatuan Republik Indonesia.</p>
                            </div>
                        </div>
                        <!-- Service Item 4 -->
                    </div>
                            ...
                            <div class="testimonial-content">
                                <div class="testimonial-text">
                                    <p>Etiam pretium ipsum quis justo dictum accumsan. Phasellus egestas
                                        odio a velit scelerisque, imperdiet elementum lorem aliquet.</p>
                                </div>
                            </div>
                            <!-- /Testimonial Content -->
